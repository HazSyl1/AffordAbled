...
class GoogleAuthClient:
    """Backend-handled Google OAuth2 authorization-code exchange. The
    frontend only forwards the authorization code; the client secret is
    read from server config and never reaches the browser."""
